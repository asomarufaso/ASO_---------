...
# সংখ্যা থেকে বাংলায় কথায় লেখার ফাংশন
def number_to_bangla_words(n):
    ...
    words = {
        ...
        11: 'এগারো', 12: 'বারো', 13: 'তেরো', 14: 'চৌদ্দ', 15: 'পনেরো', 16: 'षোলো', 17: 'সতেরো', 18: 'আঠারো', 19: 'উনিশ', 20: 'বিশ',
        21: 'একুশ', 22: '바이শ', 23: 'তেইশ', 24: 'চব্বিশ', 25: 'পঁচিশ', 26: 'ছাব্বিশ', 27: 'সাতাশ', 28: 'আটাশ', 29: 'উনত্রিশ', 30: 'ত্রিশ',
        31: 'একত্রিশ', 32: 'বত্রিশ', 33: 'তেতাল্লিশ', 34: 'চৌয়াল্লিশ', 35: 'পঁয়তাল্লিশ', 36: 'ছত্রিশ', 37: 'সাতচল্লিশ', 38: 'আটচল্লিশ', 39: 'ঊনচল্লিশ', 40: 'চল্লিশ',
...
💁‍♂️ মারুফ"""
    ...
    with tab1:
        ...
        with col1:
            ...
            water = st.number_input("پানির বিল", value=100, step=10, key="notice_water")
...
╚════ 💁‍♂️ {name} ════╝"""
        ...
        # ফিক্সড করা কমান্ড (এখন বাটন চাপলেই আউটপুট চলে আসবে)
        st.write("### 📋 আপনার ভাড়ার রসিদ রেডি:")
